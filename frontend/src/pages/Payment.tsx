...
export default function Payment() {
  ...
  //useEffect to get loged in users payment data
  useEffect(() => {
    ...
    <div className="">
      <form className="flex py-16 justify-center max-w-3xl mx-auto" onSubmit={handlePayment}>
        ...
        <div className="border border-gray-300 p-4 mt-4">
          ...
          <div className="flex flex-col mt-4">
            ...
            <input
              ...
              value={paymentData?.brand} // Set value to paymentData.name
              readOnly // Make input readonly
            />
            <label htmlFor="cardNumber" className="font-bold mt-4 mb-2">
              Card Number:
            </label>
            {/* display last 4 digits with stars */}
            <input
              type="text"
              id="cardNumber"
              className="px-3 py-2 border font-mono font-semibold text-gray-500 border-gray-300"
            ...
            <div className="flex">
              <div className="flex-1 flex flex-col pr-2">
                ...
                <input
                  ...
                  value={"***"} // Set value to paymentData.securityCode
                  readOnly // Make input readonly
                />
              </div>
              {/* display expire data and month */}
              <div className="flex-1 flex flex-col pl-2">
                ...
                <input
                  ...
                  value={`${paymentData?.exp_month}/${paymentData?.exp_year}`} // Set value to paymentData.expireDate
        ...
        <div className="flex-1 shadow-2xl flex flex-col justify-between p-4 border border-gray-300 mx-8 bg-blue-100">
          <div className="mb-4 ">
            <img src={courseData.img} alt={courseData.name} style={{ width: '100%', marginBottom: '8px' }} />
